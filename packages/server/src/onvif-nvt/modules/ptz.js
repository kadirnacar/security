...
var Ptz = /** @class */ (function () {
     ...
     */
    Ptz.prototype.init = function (timeDiff, serviceAddress, username, password) {
     ...
     */
    Ptz.prototype.setDefaultProfileToken = function (profileToken) {
     ...
     */
    Ptz.prototype.createRequest = function (body) {
    ...
    Ptz.prototype.buildRequest = function (methodName, xml, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            ...
            if (typeof xml === 'undefined' || xml === null || xml === '') {
                soapBody += "<tptz:".concat(methodName, "/>");
            }
            else {
                soapBody += "<tptz:".concat(methodName, ">");
                soapBody += xml;
            ...
            _this.soap.makeRequest('ptz', _this.serviceAddress, methodName, soapEnvelope)
     ...
     */
    Ptz.prototype.panTiltZoomOptions = function (vectors) {
        var soapBody = '';
     ...
     */
    Ptz.prototype.getNodes = function (callback) {
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.getNode = function (nodeToken, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            var errMsg = '';
            if (typeof callback !== 'undefined' && callback !== null) {
            ...
            _this.buildRequest('GetNode', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.getConfigurations = function (callback) {
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.getConfiguration = function (configurationToken, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            var errMsg = '';
            if (typeof callback !== 'undefined' && callback !== null) {
            ...
            _this.buildRequest('GetConfiguration', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.getConfigurationOptions = function (configurationToken, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            var errMsg = '';
            if (typeof callback !== 'undefined' && callback !== null) {
            ...
            _this.buildRequest('GetConfigurationOptions', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.setConfiguration = function (configurationToken, ptzConfigurationOptions, forcePersistence, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            var errMsg = '';
            if (typeof callback !== 'undefined' && callback !== null) {
            ...
            _this.buildRequest('SetConfiguration', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.getCompatibleConfigurations = function (profileToken, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            if (typeof callback !== 'undefined' && callback !== null) {
                if ((errMsg = Util.isInvalidValue(callback, 'function'))) {
            ...
            _this.buildRequest('GetCompatibleConfigurations', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.absoluteMove = function (profileToken, position, speed, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            var soapBody = '';
            soapBody += '<tptz:ProfileToken>' + profileToken + '</tptz:ProfileToken>';
            soapBody += '<tptz:Position>' + _this.panTiltZoomOptions(position) + '</tptz:Position>';
            if (typeof speed !== 'undefined' && speed !== null) {
                soapBody += '<tptz:Speed>' + _this.panTiltZoomOptions(speed) + '</tptz:Speed>';
            }
            _this.buildRequest('AbsoluteMove', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.relativeMove = function (profileToken, translation, speed, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            soapBody += '<tptz:ProfileToken>' + profileToken + '</tptz:ProfileToken>';
            if (typeof translation !== 'undefined' && translation !== null) {
                soapBody += '<tptz:Translation>' + _this.panTiltZoomOptions(translation) + '</tptz:Translation>';
            }
            if (typeof speed !== 'undefined' && speed !== null) {
                soapBody += '<tptz:Speed>' + _this.panTiltZoomOptions(speed) + '</tptz:Speed>';
            }
            _this.buildRequest('RelativeMove', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     *   })
     */
    Ptz.prototype.continuousMove = function (profileToken, velocity, timeout, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            soapBody += '<tptz:ProfileToken>' + profileToken + '</tptz:ProfileToken>';
            if (velocity) {
                soapBody += '<tptz:Velocity>' + _this.panTiltZoomOptions(velocity) + '</tptz:Velocity>';
            }
            if (timeout) {
                soapBody += '<tptz:Timeout>PT' + timeout + 'S</tptz:Timeout>';
            }
            _this.buildRequest('ContinuousMove', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.geoMove = function (profileToken, geoLocation, speed, areaWidth, areaHeight, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            _this.buildRequest('GeoMove', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.stop = function (profileToken, panTilt, zoom, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            _this.buildRequest('Stop', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.getStatus = function (profileToken, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            var soapBody = '';
            soapBody += '<tptz:ProfileToken>' + profileToken + '</tptz:ProfileToken>';
            _this.buildRequest('GetStatus', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.setPreset = function (profileToken, presetToken, presetName, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            _this.buildRequest('SetPreset', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.getPresets = function (profileToken, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            var soapBody = '';
            soapBody += '<tptz:ProfileToken>' + profileToken + '</tptz:ProfileToken>';
            _this.buildRequest('GetPresets', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.gotoPreset = function (profileToken, presetToken, speed, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            _this.buildRequest('GotoPreset', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.removePreset = function (profileToken, presetToken, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            soapBody += '<tptz:ProfileToken>' + profileToken + '</tptz:ProfileToken>';
            soapBody += '<tptz:PresetToken>' + presetToken + '</tptz:PresetToken>';
            _this.buildRequest('RemovePreset', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.gotoHomePosition = function (profileToken, speed, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            _this.buildRequest('GotoHomePosition', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.setHomePosition = function (profileToken, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            var soapBody = '';
            soapBody += '<tptz:ProfileToken>' + profileToken + '</tptz:ProfileToken>';
            _this.buildRequest('SetHomePosition', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
     ...
     * @param {callback=} callback Optional callback, instead of a Promise.
     */
    Ptz.prototype.sendAuxiliaryCommand = function (profileToken, auxiliaryData, callback) {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            profileToken = profileToken || _this.defaultProfileToken;
            var errMsg = '';
            ...
            _this.buildRequest('SendAuxiliaryCommand', soapBody)
                .then(function (results) {
                resolve(results);
            })["catch"](function (error) {
                reject(error);
