...
var Camera = /** @class */ (function () {
    ...
    Camera.prototype.add = function (name) {
        ...
        if (!MODULE_MAP[name]) {
            throw new Error("Module '".concat(name, "' does not exist. Cannot add to Camera."));
        }
        if (this[name]) {
            return;
        }
     ...
     */
    Camera.prototype.connect = function (address, port, username, password, servicePath, callback) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            // add core module
            _this.add('core');
            return _this.coreGetSystemDateAndTime()
                .then(function () {
    ...
    */
    ...
    Camera.prototype.coreGetSystemDateAndTime = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.core.getSystemDateAndTime()
            ...
            _this.core.getServices(true)
                ...
                services.forEach(function (service) {
                    ...
                    if (namespace === 'http://www.onvif.org/ver10/device/wsdl') {
                        ...
                        _this.add('media');
                        if (_this.media) {
                            _this.media.init(_this.timeDiff, new URL(service.XAddr), _this.username, _this.password);
                        ...
                        _this.add('events');
                        if (_this.events) {
                            _this.events.init(_this.timeDiff, new URL(service.XAddr), _this.username, _this.password);
                        ...
                        _this.add('ptz');
                        if (_this.ptz) {
                            _this.ptz.init(_this.timeDiff, new URL(service.XAddr), _this.username, _this.password);
                        ...
                        _this.add('imaging');
                        if (_this.imaging) {
                            _this.imaging.init(_this.timeDiff, new URL(service.XAddr), _this.username, _this.password);
                        ...
                        _this.add('deviceio');
                        if (_this.deviceio) {
                            _this.deviceio.init(_this.timeDiff, new URL(service.XAddr), _this.username, _this.password);
                        ...
                        _this.add('analytics');
                        if (_this.analytics) {
                            _this.analytics.init(_this.timeDiff, new URL(service.XAddr), _this.username, _this.password);
                    ...
                    if (analytics && 'XAddr' in analytics) {
                        if (!_this.analytics) {
                            ...
                            if (_this.analytics) {
                                ...
                                _this.analytics.init(_this.timeDiff, serviceAddress, _this.username, _this.password);
                            }
                        }
                        if (_this.analytics) {
                    ...
                    if (events && 'XAddr' in events) {
                        if (!_this.events) {
                            ...
                            if (_this.events) {
                                ...
                                _this.events.init(_this.timeDiff, serviceAddress, _this.username, _this.password);
                            }
                        }
                    ...
                    if (imaging && 'XAddr' in imaging) {
                        if (!_this.imaging) {
                            ...
                            if (_this.imaging) {
                                ...
                                _this.imaging.init(_this.timeDiff, serviceAddress, _this.username, _this.password);
                            }
                        }
                    }
                }
                    ...
                    if (media && 'XAddr' in media) {
                        if (!_this.media) {
                            ...
                            if (_this.media) {
                                ...
                                _this.media.init(_this.timeDiff, serviceAddress, _this.username, _this.password);
                            }
                        }
                    }
                }
                    ...
                    if (ptz && 'XAddr' in ptz) {
                        if (!_this.ptz) {
                            ...
                            if (_this.ptz) {
                                ...
                                _this.ptz.init(_this.timeDiff, serviceAddress, _this.username, _this.password);
                            }
                        }
                    }
                }
    ...
    Camera.prototype.coreGetDeviceInformation = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.core.getDeviceInformation()
                .then(function (results) {
    ...
    Camera.prototype.coreGetScopes = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.core.getScopes()
                .then(function (results) {
                var scopes = typeof results.data.GetScopesResponse.Scopes === 'undefined' || !Array.isArray(results.data.GetScopesResponse.Scopes) ? [] : results.data.GetScopesResponse.Scopes;
            ...
            var getStreamUri = function () {
                ...
                if (profile) {
                    ...
                    if (protocol) {
                        ...
                        _this.media.getStreamUri('RTP-Unicast', protocol, token)
                            .then(function (results) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var getSnapshotUri = function () {
                ...
                if (profile) {
                    ...
                    _this.media.getSnapshotUri(profile.$.token)
                        .then(function (results) {
                        try {
                            var service = {};
